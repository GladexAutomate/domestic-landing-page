  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center flex-shrink-0" style={{ width: "44px" }}>
        <div
          className="relative w-11 h-11 rounded-full flex items-center justify-center font-black text-white text-sm flex-shrink-0 z-10 transition-transform duration-300 hover:scale-110"
          style={{
      ...
      {/* Right: card */}
      <div
        className="flex-1 mb-5 rounded-2xl overflow-hidden group"
        style={{
          background: cardBg,
      ...
      >
        ...
        >
          <span
            className="text-[10px] font-black tracking-[0.35em] uppercase px-2.5 py-1 rounded-full"
            style={{ background: "rgba(255,140,0,0.12)", color: "#FF8C00", border: "1px solid rgba(255,140,0,0.2)" }}
          >
            {day.day}
          </span>
          <p className="font-bold text-sm uppercase tracking-wide" style={{ color: textPrimary }}>
            {day.title}
          </p>
        </div>

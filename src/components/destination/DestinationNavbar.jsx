    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-10 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            to="/"
            className="flex items-center gap-1.5 text-sm font-semibold tracking-wide transition-colors hover:text-[#FF8C00]"
          ...
          <button
            ...
            style={{
              ...
              color: darkMode ? "#FF8C00" : scrolled ? "#0F172A" : "rgba(255,255,255,0.9)",

    ...
    <Link to={`/destination/${destination.slug}`}>
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, rgba(0,0,0,0.1) 0%, rgba(0,0,0,0.45) 55%, rgba(0,0,0,0.82) 100%)",
          }}
        />
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-4">
          {/* Destination Name */}
          <h3 className="text-white font-black text-base leading-tight mb-2 drop-shadow-md transition-all duration-300 group-hover:-translate-y-1">
            {destination.name}
          </h3>

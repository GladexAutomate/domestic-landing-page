...
export const DESTINATION_DATA = {
  boracay: {
    ...
    destinationGuide: {
      ...
      food: [
        { name: "Chori Burger", restaurant: "Jonah's Fruit Shake & Restaurant", note: "Boracay's most iconic street food — order right on the beachfront at Station 2", emoji: "🍔", image: boracayImgs.foodChoriBurger },
        { name: "Fresh Seafood Grill", restaurant: "D'Talipapa Market", note: "Pick your catch fresh from the market, have it grilled next door — freshest BBQ on the island", emoji: "🦞", image: boracayImgs.foodSeafoodGrill },
        ...
        { name: "Calamari", restaurant: "Sunny Side Cafe", note: "Golden crispy calamari — a popular crowd-pleaser at this beloved White Beach brunch spot", emoji: "🦑", image: boracayImgs.foodTalaba },
        { name: "Four Cheese Pizza", restaurant: "Two Seasons Boracay", note: "Signature wood-fired pizza with four melted cheeses — one of the island's top-rated restaurants", emoji: "🍕", image: boracayImgs.foodHaloHalo },
        { name: "Oyster Sisig", restaurant: "D'Talipapa Market", note: "Fresh oysters from the market stalls cooked sizzling sisig-style — a must-try Boracay specialty", emoji: "🦪", image: boracayImgs.foodBukoJuice },
        { name: "Spanish Tapas & Paella", restaurant: "Dos Mestizos", note: "Authentic Spanish cuisine in a stunning beachfront setting — beloved by repeat visitors", emoji: "🥘", image: boracayImgs.foodInihaw },
        { name: "Grilled Chicken", restaurant: "Spicebird", note: "Boldly spiced rotisserie chicken with signature sauces — great for a casual beachside meal", emoji: "🍗", image: boracayImgs.foodTamilok },
      ],
      photoSpots: [
  ...
  cebu: {
    ...
    bannerImages: {
      ...
      currency:    "https://images.pexels.com/photos/3723493/pexels-photo-3723493.jpeg?auto=compress&cs=tinysrgb&w=1400",
  ...
  elnido: {
    ...
    bannerImages: {
      ...
      currency:    "https://images.pexels.com/photos/1591056/pexels-photo-1591056.jpeg?auto=compress&cs=tinysrgb&w=1400",

...
export const DESTINATION_DATA = {
  boracay: {
    ...
    destinationGuide: {
      highlights: [
        { name: "White Beach", desc: "The most famous beach in Boracay — powdery white sand, crystal-clear waters, restaurants, and vibrant nightlife. Best experienced in the morning before crowds arrive.", icon: "🏖️", image: "https://images.unsplash.com/photo-1518548419970-58e3b4079ab2?w=900&q=85" },
        { name: "Island Hopping", desc: "Explore Boracay's surrounding islands by boat — visit Crystal Cove, Crocodile Island, and snorkel in pristine waters with colorful marine life.", icon: "⛵", image: "https://images.unsplash.com/photo-1499678329028-101435549a4e?w=900&q=85" },
        { name: "Sunset at White Beach", desc: "Boracay's world-famous sunset is ranked among the best in Asia. Grab a beachside seat, order a fresh buko, and watch the sky turn gold.", icon: "🌅", image: "https://images.unsplash.com/photo-1503614472-8c93d56e92ce?w=900&q=85" },
        { name: "Snorkeling & Underwater", desc: "Vibrant coral gardens and diverse marine life await just offshore. Snorkeling gear is available for rent and included in most island hopping tours.", icon: "🤿", image: "https://images.unsplash.com/photo-1540979388789-6cee28a1cdc9?w=900&q=85" },
        { name: "Puka Shell Beach", desc: "A quieter, more natural beach on the northern tip of the island — perfect for relaxation, shell hunting, and authentic island photography.", icon: "🐚", image: "https://images.unsplash.com/photo-1519451241324-20b4ea2c4220?w=900&q=85" },
        { name: "Marine Life & Reefs", desc: "Boracay's surrounding waters are home to sea turtles, reef fish, and living corals. Helmet diving and scuba are available for all experience levels.", icon: "🐠", image: "https://images.unsplash.com/photo-1565118531796-763e5082d113?w=900&q=85" },
      ],
      food: [
      ...
      photoSpots: [
        { name: "White Beach Station 1", note: "Best shot early morning — powdery white sand, turquoise water, no crowds", image: "https://images.unsplash.com/photo-1511316695145-4992006ffddb?w=600&q=80" },
        { name: "Willy's Rock at Sunrise", note: "Iconic volcanic rock formation — golden hour at 6–7 AM is magical", image: "https://images.unsplash.com/photo-1579033462043-0f11a7862f7d?w=600&q=80" },
        { name: "Puka Shell Beach", note: "Quiet northern beach — natural and unpolished, perfect for travel photography", image: "https://images.unsplash.com/photo-1548574505-5e239809ee19?w=600&q=80" },
        { name: "Island Hopping Boat Deck", note: "Shoot back toward the island from the boat — frames the limestone views perfectly", image: "https://images.unsplash.com/photo-1559827291-72ee739d0d9a?w=600&q=80" },
      ],
    ...
    optionalTours: [
      {
        ...
        description: "Explore Boracay's best surrounding islands and crystal-clear snorkeling spots.",
        stops: ["Crystal Cove", "Crocodile Island", "Snorkeling Areas", "Puka Beach"],
        icon: "⛵",
        duration: "Full Day (8 AM – 3 PM)",
        highlights: ["Snorkeling gear included", "Multiple island stops", "Packed lunch"],
        badge: null,
      },
      {
        name: "Parasailing",
        description: "Experience breathtaking aerial views of Boracay's iconic coastline.",
        stops: [],
        icon: "🪂",
        duration: "15–20 minutes",
        highlights: ["Solo or tandem available", "Panoramic ocean views", "Safety harness provided"],
        badge: "Thrill Seeker",
      },
      {
        name: "Sunset Paraw Sailing",
        description: "A relaxing traditional Filipino sailboat ride while watching Boracay's famous sunset.",
        stops: [],
        icon: "🌅",
        duration: "1 hour",
        highlights: ["Traditional paraw sailboat", "World-famous sunset", "Romantic experience"],
        badge: "Most Popular",
      },
      {
        name: "Helmet Diving",
        description: "Walk underwater and interact with marine life — no certification needed.",
        stops: [],
        icon: "🤿",
        duration: "15–20 minutes",
        highlights: ["No experience required", "Underwater walk", "Marine life encounter"],
        badge: null,
      },
      {
        name: "ATV Adventure",
        description: "Explore Boracay's scenic inland trails and discover the island beyond the beach.",
        stops: [],
        icon: "🏍️",
        duration: "30–60 minutes",
        highlights: ["Off-road terrain", "Island interior views", "Thrilling experience"],
        badge: null,
      },
    ],
    notes: [

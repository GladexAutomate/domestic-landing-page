...
export default function DestinationPreview() {
  ...
  return (
    <div className="font-poppins min-h-screen transition-colors duration-500" style={{ background: bg }}>
      <DestinationNavbar />
      ...
      <section className="relative overflow-hidden" style={{ height: "100vh", minHeight: "560px" }}>
        ...
        <div
          ...
          style={{ backgroundImage: `url('${heroImage}')`, animation: "heroKenBurns 14s ease-out forwards" }}
        />
        ...
        <div
          className="absolute inset-0"
          style={{ background: "linear-gradient(90deg, rgba(0,0,0,0.25) 0%, transparent 25%, transparent 75%, rgba(0,0,0,0.25) 100%)" }}
        />
        {/* Orange accent glow */}
        <div
